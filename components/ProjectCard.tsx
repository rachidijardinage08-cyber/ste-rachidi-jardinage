...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    <div className="group bg-white rounded-[35px] md:rounded-[45px] border border-slate-100 overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 ease-out cursor-pointer flex flex-col shadow-sm h-full">
      {/* Image Section */}
      <div className="relative h-56 md:h-72 overflow-hidden bg-emerald-50">
        ...
        {/* Overlay Tags (PC Only for cleaner mobile UI) */}
        <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/70 via-transparent to-transparent opacity-0 lg:group-hover:opacity-100 transition-opacity duration-500 hidden lg:flex items-end p-8 pointer-events-none">
      ...
      <div className="p-6 md:p-10 flex-grow flex flex-col">
        ...
        <div className="mt-auto pt-4 md:pt-6 border-t border-slate-50 flex items-center justify-between">
           <span className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">Explorer</span>
